...
import { faShippingFast, faDollarSign, faCreditCard, faHeadset } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div>
      <div style={styles.container}>
        ...
        <img
          src="https://miro.medium.com/v2/resize:fit:828/format:webp/0*ox2XCVWA1F_e2hUJ"
          alt="Room Scene"
        ...
        <div style={styles.textSection}>
          ...
          <button
            ...
            onMouseOver={(e) => (e.currentTarget.style.backgroundColor = styles.shopButtonHover.backgroundColor)}
            onMouseOut={(e) => (e.currentTarget.style.backgroundColor = styles.shopButton.backgroundColor)}
          >
            SHOP NOW!
          </button>
        </div>
      ...
      <div style={styles.newSection}>
        <div
          style={{
            ...
            backgroundImage: "url('https://i.pinimg.com/originals/d2/c4/a9/d2c4a987416b76e4d2781e2cd97ff6c8.jpg')",
          }}
        >
        ...
        <div
          style={{
            ...
            backgroundImage: "url('https://th.bing.com/th/id/OIP.0gPm7veLpebWbfgTLrvVIgHaE8?rs=1&pid=ImgDetMain')",
          }}
        >
          <div style={styles.overlay}></div>
          <div style={styles.sectionContent}>
        ...
        <div
          style={{
            ...styles.smallSectionItem,
            backgroundImage: "url('https://www.shutterstock.com/image-photo/stylish-fashion-child-baby-girl-260nw-1769789042.jpg')",
          }}
        >
          <div style={styles.overlay}></div>
          <div style={styles.sectionContent}>
        ...
        <div
          style={{
            ...styles.largeSectionItem,
            backgroundImage: "url('https://th.bing.com/th/id/OIP.vcUsqpCQzTNwZLvTkSuQZgHaEK?w=1000&h=562&rs=1&pid=ImgDetMain')",
          }}
        >
          <div style={styles.overlay}></div>
          <div style={styles.sectionContent}>
